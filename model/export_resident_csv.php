...
// get Users
$query = "SELECT national_id,firstname,middlename,lastname,alias,birthplace,birthdate,age,civilstatus,gender,voterstatus,identified_as,phone,email,address FROM residents";
