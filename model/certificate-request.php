...
if (isset($_POST["request-certificate"])) {
	...
	$owner1 = getBody("business_owner_1", $_POST);
	$owner2 = getBody("business_owner_2", $_POST);
	...
	$result = $db
		...
		->values([
			...
			"business_name" => $name,
			"business_owner_1" => $owner1,
			"business_owner_2" => $owner2,
			"business_nature" => $nature,
			"cutting_material" => $material,
			"cutting_quantity" => $quantity,
			"cutting_location" => $location,
		])
		->exec();
