...
if (isset($_GET['request_id'])) {
  $request = $db
    ...
    if (!empty($request)) {
      // No need to decode JSON for business name
      $permit['name'] = $request['business_name']; // Use the business_name directly
      $permit['owner1'] = $request['business_owner_1'];
      $permit['owner2'] = $request['business_owner_2'];
      $permit['nature'] = $request['business_nature'];
...
$showPaymentModal = !in_array($request_status, ['resolved', 'already paid']);
...
<html lang="en">
  ...
  <head>
    ...
    <title>Business Permit - Barangay Online System</title>
    <style>
    @page {
      size: auto;
  ...
  <body>
                    ...
                    <div class="row mt-2">
                      <div class="col-md-12">
                        ...
                        <div class="text-center pt-4 mb-5">
                          ...
                          <hr class="w-50 mt-0 mb-0 mx-auto" style="border-top: 2px solid black;">
                          <h2 class="mt-0">NAME OF BUSINESS OWNERS</h2>
                        </div>
              ...
              <div class="modal-body">
                <form method="POST" action="model/save_pment.php">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" id="dateIssued" class="form-control" name="date" value="<?= date('Y-m-d') ?>">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" placeholder="Enter Payment Details"
                      name="details" <?= ifThen(!isUser(), "readonly") ?>>Business Permit Payment</textarea>
                  </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('dateIssued').value = today; // Set today's date as the default value
    });
    </script>
  </body>
