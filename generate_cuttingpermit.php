...
if (isset($_GET['request_id'])) {
  ...
  if (!empty($cr_request)) {
    // Assuming fullname() is a function that combines first, middle, and last names
    $request['name'] = fullname($cr_request);
    $request['pcs'] = $cr_request['cutting_quantity']; // Directly from the query
    $request['type'] = $cr_request['cutting_material']; // Directly from the query
    $request['location'] = $cr_request['cutting_location']; // Directly from the query
