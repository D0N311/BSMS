          ...
          <div class="page-inner">
            <div class="fadeIn card">
              <div class="login-form card-body">
                ...
                <h3 class="card-title text-center fw-bold mb-3">Registration Form</h3>
                <?php endif; ?>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="row g-0">
                        ...
                        <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="Enter Birthdate" id="birthdate" name="birthdate"
                              required>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row g-0">
                        <div class="col-sm-4">
                          <div class="form-group">
                            <label>Age</label>
                            <input type="number" class="form-control" placeholder="Enter Age" min="1" id="age" name="age"
                              required>
                          </div>
                        </div>
