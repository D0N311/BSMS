                      ...
                      <div class="col-md-3">
                        <div class="text-center p-3">
                          ...
                          <h5 class="mt-3 mb-0">
                            <b>VISION:</b>
                            <i>
                            We envision Barangay Gusa
                            as a vibrant and inclusive community
                            where everyone feels safe, valued, and connected.
                            It’s a place where progress and unity go hand in hand, 
                            and people work together to create a brighter future for all.
                            </i>
                          </h5>
                          <br>
                          <h5 class="mb-2 ">
